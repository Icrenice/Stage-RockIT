...
if (isset($_SESSION['leerling_data']) || isset($_SESSION['coach_data'])|| isset($_SESSION['admin_data']) || isset($_SESSION['bedrijf_data']) ) {
    ...
    <br>
    <div class="container">
    <h1>Praktijkbegeleider Bedrijf</h1>
        <div class="row">
            <div class="col-sm">
                <a href="bedrijventoevoegen.php">
                    <img src="img/users.png" width="175px" height="175px"><br>
                    <button type="button" class="btn btn-color">Praktijkbegeleider Bedrijf Toevoegen</button>
                </a>
            </div>

            <div class="col-sm">
                <a href="pbboverzicht.php">
                    <img src="img/users.png" width="175px" height="175px"><br>
                    <button type="button" class="btn btn-color">Praktijkbegeleider Bedrijf Overzicht</button>
                </a>
                </a>
            </div>
        </div>
