    ...
    <div class="container-fluid">
        <div class="row content">
            <div class="row text-center">
                <h1 class="text-center my-3">Bedrijven overzicht</h1>
                <hr>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $bedrijf_data['bedrijfsnaam']; ?></td>

                                                <td>

                                                    <?php echo   $bedrijf_data['kvknummer']; ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    echo  $bedrijf_data['straat'] . " " . $bedrijf_data['huisnummer'] . $bedrijf_data['huisnummertoevoeging'];
                                                ...
                                                <td>
                                                    <?php
                                                    echo  $bedrijf_data['plaats'] . " " . $bedrijf_data['postcode'];
                                                ...
                                                <td>
                                                    <?php
                                                    echo  $bedrijf_data['telefoonnummer'];
                                                ...
                                                <td>
                                                    ...
                                                    <form method="get" action="../bedrijfwijzigen.php">

                                                        <input type="hidden" name="bedrijvenid" value="<?php echo $bedrijf_data['id_gebruiker'] ?>">
                                                        <input type="hidden" name="rol" value="<?php echo $bedrijf_data['rol'] ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <form method="get" action="#">
                                                        ...
                                                        <input type="hidden" name="bedrijvenid" value="<?php echo $bedrijfid;
                                                                                                        ?>">
