...
if (isset($_POST['submit'])) {
    ...
    if (isset($error)) {
        ...
        $Leerlingen->create($geslacht, $titel, $geboortedatum, $rol, $voornaam, $tussenvoegsel, $achternaam, $straat, $huisnummer, $huisnummertoevoeging, $postcode, $plaats, $land, $email, $telefoonnummer, $mobielnummer, $wachtwoord);
