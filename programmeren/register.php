...
<body>
    ...
    <div class="login-form">
        ...
        <div class="container">
            ...
            <form class="form-login" method="POST" id="login-form" action="forms/register.php">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="huisnummertvg" placeholder="Huisnummertoevoeging">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="telefoonnmr" placeholder="Telefoonnummer">

                </div>

                <div class="form-group">
                    <input type="text" class="form-control" name="mobielnmr" placeholder="Mobielnummer">
                ...
                <div class="form-group">
                    <input type="password" class="form-control" name="wachtwoord2" placeholder="wachtwoord">
