    ...
    <div class="container mt-4">
        <div class="row text-center">
            ...
            <form name="contact" action="" method="post">
                <label>Naam</label>
                <input type="text" class="form-control mb-4 text-center" name="naam" placeholder="Type hier uw naam in...">


                <label>Onderwerp</label>
                <input type="text" class="form-control mb-4 text-center" name="naam" placeholder="Vul uw onderwerp in...">


                <label>Bericht</label>
                <textarea id="message" class="form-control mb-4" rows="7" cols="130%"></textarea>
